...
PROTOCOLE D'ESCALADE AUTOMATIQUE — a appliquer SANS attendre l'utilisateur :
  ...
  Tentative 2 : REFORMULER — changer les termes :
    ...
    → Termes : varier "stats" / "statistics" / "standings" / "roster" / "schedule"
  Tentative 3 : CHANGER DE SOURCE — passer a la source suivante dans la hierarchie
  Tentative 4 : SOURCE ALTERNATIVE — Google News, Wikipedia, site officiel ligue/IIHF
...
⚠️ BOUCLE OBLIGATOIRE — repeter SANS attendre l'utilisateur :
  TANT QUE Confiance_brute < 21/25 ET nb_recherches_total < 30 :
    1. Classer les donnees manquantes par IMPACT sur le verdict :
       Priorite : donnees de scoring (xG/Corsi/lambda) > classement/Elo > forme >
                  H2H > absences gardien > cotes > contexte
...
|---|----------------------------|--------------|-----------|------------|-------------|--------|---------------|
| 1 | Match winner (temps reg.)  | [Equipe]     |     %     |            |             |        |               |
| 2 | Match winner (incl. OT/SO) | [Equipe]     |     %     |            |             |        |               |
| 3 | Puck line -1.5             | [Equipe]     |     %     |            |             |        |               |
| 4 | Puck line +1.5             | [Equipe]     |     %     |            |             |        |               |
| 5 | Total buts Over X.5        |              |     %     |            |             |        |               |
| 6 | Total buts Under X.5       |              |     %     |            |             |        |               |
| 7 | Total equipe Over X.5      | [Equipe]     |     %     |            |             |        |               |
| 8 | BTTS (les 2 marquent)      | [Oui/Non]    |     %     |            |             |        |               |
| 9 | Prolongation (OT/SO)       | [Oui/Non]    |     %     |            |             |        |               |
|10 | 1ere periode winner        | [Equipe/Nul] |     %     |            |             |        |               |
...
- Distinguer temps reglementaire vs incl. OT/SO dans les probabilites
